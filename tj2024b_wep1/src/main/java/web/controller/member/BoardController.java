...
public class BoardController extends HttpServlet {
	...
	//*만약에 끝번호가 전체 페이지수보다 커지면 안되므로 끝번호가 전체페이지수 보다 커지면 전체 페이지 수로 고정
	if(endBtn > totalPage)endBtn = totalPage;
		...
		pageDto.setStartbtn(startRow); // 페이징 버튼 시작번호
